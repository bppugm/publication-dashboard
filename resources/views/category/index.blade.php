...
<div class="container h-100">
    ...
    <div class="d-flex justify-content-between my-30">
        ...
        <nav class="breadcrumb m-0">
            <a class="breadcrumb-item active" aria-current="category" style="text-decoration: none"><b>Category
                    List</b></a>
        </nav>
    </div>
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="/data" class="text-decoration-none">
                    <button class="nav-link disabled" id="category-tab" data-bs-toggle="tab" data-bs-target="#category"
            ...
            <li class="nav-item" role="presentation">
                <a href="/category" class="text-decoration-none">
                    <button class="nav-link nav-tabs active border-0" id="category-tab" data-bs-toggle="tab"
